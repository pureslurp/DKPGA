...
df_merge = past_results_dyn(df_merge, 'https://www.pgatour.com/tournaments/at-t-byron-nelson/past-results.html', upperBound=4.5)
#df_merge = past_results(df_merge, 'https://www.espn.com/golf/leaderboard/_/tournamentId/3068', upperBound=2.5, pr_i=1, playoff=True)
