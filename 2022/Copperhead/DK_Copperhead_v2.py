...
path = '2022/Copperhead/'
name = 'DKSalaries-Copperhead.csv'
...
df_merge = course_fit(df_merge, multiplier=22)
df_merge = past_results(df_merge, 'https://www.espn.com/golf/leaderboard/_/tournamentId/401243433', upperBound=4)
df_merge = past_results(df_merge, 'https://www.espn.com/golf/leaderboard/_/tournamentId/401056523', upperBound=2, pr_i=1)
