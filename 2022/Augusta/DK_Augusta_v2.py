...
df_merge = past_results_dyn(df_merge, 'https://www.pgatour.com/tournaments/masters-tournament/past-results.html', upperBound=4.5)
df_merge = past_results_dyn(df_merge, 'https://www.pgatour.com/tournaments/masters-tournament/past-results.html', upperBound=2.5, pr_i=1)
...
while k < 200:
    ...
    if currentIter > (mean + sigma - 15) and constraint(lineup, df_merge):
