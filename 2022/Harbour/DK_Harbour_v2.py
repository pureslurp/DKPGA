...
df_merge = past_results_dyn(df_merge, 'https://www.pgatour.com/tournaments/rbc-heritage/past-results.html', upperBound=4.5)
df_merge = past_results_dyn(df_merge, 'https://www.pgatour.com/tournaments/rbc-heritage/past-results.html', upperBound=2.5, pr_i=1)
