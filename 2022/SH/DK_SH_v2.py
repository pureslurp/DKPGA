...
#2021
df_merge = past_results(df_merge, 'https://www.espn.com/golf/leaderboard?tournamentId=401243418', upperBound=2, playoff=False)
df_merge = past_results(df_merge, 'https://www.espn.com/golf/leaderboard?tournamentId=401243010', upperBound=2, playoff=False, pr_i=1)
df_merge = past_results(df_merge, 'https://www.espn.com/golf/leaderboard?tournamentId=401243414', upperBound=2, playoff=False, pr_i=2)
df_merge = past_results(df_merge, 'https://www.espn.com/golf/leaderboard?tournamentId=401243410', upperBound=2, playoff=False, pr_i=3)
#2022
...
while k < 200:
    ...
    if currentIter > (mean + sigma + 7) and constraint(lineup, df_merge):
