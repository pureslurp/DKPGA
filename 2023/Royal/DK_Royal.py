...
# df_merge = last_x_majors_dk_points(df, events=4)

# df_merge = last_x_events_dk_points(df_merge, events=5)
...
df_merge = pd.read_csv('{}/CSVs/DKData.csv'.format(path))

df_merge = df_total_and_reformat(df_merge, pr_multi=1)
